        ...
        <nav class="nav">
            <div> <a href="#" class="nav_logo"> <i class='bx bx-camera nav_logo-icon'></i> <span class="nav_logo-name">PICNETTE</span> </a>
                <div class="nav_list"> 
                  ...
                  <a href="{{route('detailBooking')}}" class="nav_link active"> 
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$item['id']}}</td>
                        <td>{{$user[0]->where('id', $item->user_id)->first()->name}}</td>
                        <td>{{$produk[0]->where('id', $item->product_id)->first()->name_product}}</td>
                        <td>{{$item['tanggal_booking']}}</td>
                        <td>{{$item['status']}}</td>
                        <td>{{$item['kode_booking']}}</td>
                        <td>{{$item['total']}}</td>
                        <td>
                        <a href="{{ url('edit-booking' , $item['id']) }}" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="{{ url('delete-booking' , $item['id']) }}" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>     
                    @endforeach
                </tbody>
