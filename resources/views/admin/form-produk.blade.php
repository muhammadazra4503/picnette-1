    ...
    <div class="container-body">
        ...
        <fieldset>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="banyakshoot" class="form-control" >
                </div>

                <!-- field untuk -->
                <div class="mb-3">
                    <label for="banyakfile" class="form-label">Banyak File</label>
                    <input type="text" name="banyakfile" class="form-control">
                </div>
                ...
                <!-- field untuk -->
                <div class="mb-3">
                    <label for="fotokeluarga" class="form-label">Foto Keluarga</label>
                    <select name="fotokeluarga" id="">
